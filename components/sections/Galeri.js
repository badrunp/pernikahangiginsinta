    ...
    <div id="galeri" className="w-full h-auto relative pb-24 px-4 pt-12">
      ...
      <div className="grid grid-cols-2 gap-2">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
          <ModalImage
            small={"/assets/image/mempelai/1.jpeg"}
            large={"/assets/image/mempelai/1.jpeg"}
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
          <ModalImage
            small={"/assets/image/mempelai/2.jpeg"}
            large={"/assets/image/mempelai/2.jpeg"}
            className="relative w-full h-[190px] object-cover rounded-md"
            hideDownload
            hideZoom
          />
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
          <ModalImage
            small={"/assets/image/mempelai/3.jpeg"}
            large={"/assets/image/mempelai/3.jpeg"}
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
          <ModalImage
            small={"/assets/image/mempelai/4.jpeg"}
            large={"/assets/image/mempelai/4.jpeg"}
            className="relative w-full h-[190px] object-cover rounded-md object-top"
            hideDownload
            hideZoom
          />
