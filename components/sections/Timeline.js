    ...
    <div class="flex h-screen items-center justify-center bg-white px-6 md:px-60">
     <div class="space-y-6 border-l-2 border-dashed">
      <div class="relative w-full">
       ...
       <div class="ml-6">
        <h4 class="font-bold text-blue-500">Pertemuan.</h4>
      ...
      <div class="relative w-full">
       ...
       <div class="ml-6">
        <h4 class="font-bold text-blue-500">Pendekatan.</h4>
        <p class="mt-2 max-w-screen-sm text-sm text-gray-500">
      ...
      <div class="relative w-full">
       ...
       <div class="ml-6">
        <h4 class="font-bold text-blue-500">Lamaran.</h4>
        <p class="mt-2 max-w-screen-sm text-sm text-gray-500">
      ...
      <div class="relative w-full">
       ...
       <div class="ml-6">
        <h4 class="font-bold text-blue-500">Pernikahan.</h4>
        <p class="mt-2 max-w-screen-sm text-sm text-gray-500">
