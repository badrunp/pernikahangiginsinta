   ...
   <div className="absolute z-40 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 px-6 w-full h-auto">
    <div className="text-center space-y-8 relative">
     ...
     <div className="relative text-gray-800">
      ...
      />
      <h4 className="font-semibold">Kamis, 25 April 2024</h4>
      <p className="text-sm mb-1">Pukul 08:00 - Selesai</p>
      <AkadNikah />
      <p className="text-gray-800 mt-2">
       Blok Bojong Ciherang RT. 004 / RW. 004, Desa Cidulang, Kec. Cikijing, Kab. Majalengka, Jawa Barat 45466.
      </p>
      <a
       href="https://maps.app.goo.gl/o6vjMt1TGajWnWCy5"
       target="_blank"
     ...
     <div>
      ...
      />
      <h4 className="font-semibold">Kamis, 25 April 2024</h4>
      <p className="text-sm mb-1">Pukul 10:00 - Selesai</p>
      <Resepsi />
      <p className="text-gray-800 mt-2">
       Blok Bojong Ciherang RT. 004 / RW. 004, Desa Cidulang, Kec. Cikijing, Kab. Majalengka, Jawa Barat 45466.
      </p>
