...
const dataImage = [
  {
    id: 1,
    url: "/assets/image/mempelai/2.jpeg",
    className: "",
  },
  {
    id: 2,
    url: "/assets/image/mempelai/1.jpeg",
    className: "",
  },
  {
    id: 3,
    url: "/assets/image/mempelai/3.jpeg",
    className: "object-top",
  },
  {
    id: 4,
    url: "/assets/image/mempelai/4.jpeg",
    className: "",
  },
];
  ...
  return (
    <div className="w-full h-[600px] relative overflow-hidden">
      ...
      <div className="absolute z-20 bottom-4 sm:bottom-0 left-1/2 -translate-x-1/2 text-center">
        <h1 className="font-bold text-3xl mb-1 font-gv">Maman & Eka</h1>
        <h5 className="font-semibold mb-6 ">Kamis, 23 Februari 2023</h5>
